...
def verify_batch_download():
    with sync_playwright() as p:
        ...
        # Override window.prompt to return a test path
        ...
        if btn.is_visible():
            ...
            print("FAIL: Download All button missing.")
            return

        # Click it
        # We need to intercept the batch call to verify payload
        ...
        page.screenshot(path="verification/12_batch_download.png")
        browser.close()
